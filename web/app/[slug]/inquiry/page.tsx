  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold text-gray-900 mb-2">협찬 제안서 보내기</h1>
          <p className="text-gray-500 text-sm">브랜드 정보와 협찬 내용을 작성해주세요.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="bg-white rounded-2xl p-6 shadow-sm space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6C63FF] focus:border-transparent"
              />
              <p className="text-xs text-gray-400 mt-1">개인 이메일(Gmail, Naver 등)은 허용되지 않습니다.</p>
            </div>

            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                사업자 번호 <span className="text-gray-400 font-normal">(선택)</span>
              </label>
              <input
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm space-y-5">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                예산 <span className="text-gray-400 font-normal">(원)</span>
              </label>
              <input
                name="budget"
                type="number"
            ...
            <div>
              ...
              <input
                name="deadline"
                type="date"
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#6C63FF] focus:border-transparent"
              />
            </div>
