...
const cs = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: space.screen, paddingVertical: space.md, backgroundColor: '#fff', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#E5E7EB', gap: space.sm },
  backBtn: { padding: 4 },
  ...
  proposalBanner: { backgroundColor: '#EEF2FF', paddingHorizontal: space.screen, paddingVertical: space.sm, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: space.sm },
  proposalBannerText: { ...typography.caption, color: '#3D5AFE', fontWeight: '600', flex: 1 },
  proposalBtnRow: { flexDirection: 'row', gap: space.xs },
  rejectBtn: { paddingHorizontal: space.md, paddingVertical: 6, borderRadius: 8, backgroundColor: '#F3F4F6' },
  rejectText: { fontSize: 13, fontWeight: '700', color: '#6B7280' },
  acceptBtn: { paddingHorizontal: space.md, paddingVertical: 6, borderRadius: 8, backgroundColor: '#3D5AFE' },
  ...
  statusRejected: { backgroundColor: '#F9FAFB' },
  ...
  brandBubble:  { backgroundColor: '#fff', borderBottomLeftRadius: 4, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, shadowOffset: { width: 0, height: 1 }, elevation: 1 },
  creatorBubble:{ backgroundColor: '#3D5AFE', borderBottomRightRadius: 4 },
  bubbleText:   { ...typography.body, color: colors.text.primary, lineHeight: 20 },
  creatorText:  { color: '#fff' },
  ...
  inputBar: { flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: space.screen, paddingTop: space.sm, backgroundColor: '#fff', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#E5E7EB', gap: space.sm },
