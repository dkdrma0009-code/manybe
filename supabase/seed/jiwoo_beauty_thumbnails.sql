-- Supabase SQL Editor에서 실행 (기존 highlights에 썸네일 추가)
UPDATE media_kits
SET highlights = '[
  {
    "id": "1",
    ...
    "items": [
      {
        "label": "스킨케어 루틴 공개 (feat. 이니스프리)",
        "value": "조회수 120만",
        "note": "좋아요 4.2만 · 댓글 2,800개",
        "thumbnail": "https://img.youtube.com/vi/dQw4w9WgXcQ/mqdefault.jpg"
      },
      {
        "label": "여름 선크림 4종 비교 리뷰",
        "value": "조회수 85만",
        "note": "좋아요 3.1만 · 구독자 급증 영상",
        "thumbnail": "https://img.youtube.com/vi/9bZkp7q19f0/mqdefault.jpg"
      },
      {
        "label": "무신사 콜라보 언박싱 + 메이크업",
        "value": "조회수 61만",
        "note": "브랜드 직접 협찬 제작",
